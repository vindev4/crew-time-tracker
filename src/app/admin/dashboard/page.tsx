...
/* Ã¢ÂÂÃ¢ÂÂ i18n Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ */
const t = {
  en: {
  ...
  es: {
    ...
    filterName: "Nombre del filtroÃ¢ÂÂ¦",
    save: "Guardar",
    date: "Fecha",
    employee: "Empleado",
    startTime: "Inicio",
    ...
    hours: "Horas",
    weekHrs: "Hrs Sem",
    jobLocation: "Trabajo / UbicaciÃÂ³n",
    notes: "Notas",
    submitted: "Enviado",
    actions: "Acciones",
    edit: "Editar",
...
/* Ã¢ÂÂÃ¢ÂÂ Component Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ */
export default function AdminDashboard() {
  ...
  function sortArrow(col: string) {
    if (sortCol !== col) return " Ã¢ÂÂ";
    return sortDir === "asc" ? " Ã¢ÂÂ" : " Ã¢ÂÂ";
  }
    ...
    <div className="min-h-screen bg-[#00467F]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-5">
        ...
        <div className="md:hidden mb-3">
          <button onClick={() => setFiltersOpen(!filtersOpen)} className="flex items-center gap-2 text-white/60 text-xs font-medium uppercase tracking-wider">
            ...
            {(selectedEmployees.length > 0 || selectedLocations.length > 0 || overtimeOnly || datePreset !== "thisWeek") && (
              <span className="bg-[#F37C05]/20 text-[#F37C05] px-1.5 py-0.5 rounded text-[10px]">Ã¢ÂÂ</span>
            )}
          </button>
        </div>
            ...
            <div className="flex-shrink-0 relative" ref={empDropRef}>
              ...
              {empDropOpen && (
                <div className="absolute top-full left-0 mt-1 bg-[#002a4d] border border-white/10 rounded-xl shadow-2xl z-40 min-w-[200px] max-h-60 overflow-y-auto">
                  ...
                  {employees.length === 0 && <div className="px-3 py-2 text-white/30 text-xs">Ã¢ÂÂ</div>}
                </div>
              )}
            </div>
            ...
            <div className="flex-shrink-0 relative" ref={locDropRef}>
              ...
              {locDropOpen && (
                <div className="absolute top-full left-0 mt-1 bg-[#002a4d] border border-white/10 rounded-xl shadow-2xl z-40 min-w-[200px] max-h-60 overflow-y-auto">
                  ...
                  {locations.length === 0 && <div className="px-3 py-2 text-white/30 text-xs">Ã¢ÂÂ</div>}
                </div>
              )}
            </div>
          ...
          <div className="flex flex-wrap items-center gap-2 mt-3 pt-3 border-t border-white/5">
            ...
            {savedFilters.map((f, i) => (
              <div key={i} className="flex items-center gap-1 bg-white/5 rounded-lg">
                ...
                <button onClick={() => deleteFilter(i)} className="px-1.5 py-1 text-white/20 hover:text-red-400 text-[10px] transition-colors">Ã¢ÂÂ</button>
              </div>
            ))}
            {!showSaveInput ? (
              ...
              <div className="flex items-center gap-1">
                ...
                <button onClick={() => { setShowSaveInput(false); setFilterNameInput(""); }} className="text-[10px] text-white/30 hover:text-white/60">Ã¢ÂÂ</button>
              </div>
            )}
          </div>
        </div>
        ...
        {otSummary.count > 0 && (
          <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl px-4 py-2.5 mb-4 flex items-center gap-3">
            ...
            <span className="text-amber-300 text-xs">
              <span className="font-semibold">{otSummary.count}</span> {lang === "en" ? "employee(s) with overtime" : "empleado(s) con horas extra"} Ã¢ÂÂ <span className="font-semibold">{otSummary.hours}</span> {lang === "en" ? "total OT hours in view" : "horas extra totales a la vista"}
            </span>
          </div>
        )}
        ...
        <div className="flex items-center justify-between mb-3">
          <span className="text-white/30 text-xs">{reports.length} {lang === "en" ? "reports" : "reportes"}{loading ? " Ã¢ÂÂ¦" : ""}</span>
        </div>
